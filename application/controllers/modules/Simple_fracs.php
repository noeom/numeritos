...
class Simple_fracs extends MY_Controller {
    ...
    public function init()
    {
        ...
        $module = $this->modules_model->getModuleByKey("SIMPLE_FRACS");
        ...
        $this->load->model('modSimpleFracs_model');
        $num_exercises = $this->modSimpleFracs_model->getNumExercises();
        ...
        redirect('modules/simple_fracs/show');
    }
    ...
    public function show()
    {
        ...
        $this->load->model('modSimpleFracs_model');
        $this->session->exercise = $this->modSimpleFracs_model->getExerciseById($this->session->current_exercise_index);

        // Show view.
        $this->loadModularView('mod_simple_fracs');
    }
    ...
    public function check()
    {
        ...
        $data['action'] = 'modules/simple_fracs/show';
